const CACHE='xandy-studio-v2';
const ASSETS=['./','./index.html','./estilos.html','./3camadas.html','./deuses.html','./personagens.html','./manifest.webmanifest','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
